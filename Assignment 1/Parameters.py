...
T_MAX = 15                              # Time-interval of each plot-segment (length of time-dependent plots)

FIGURE_RATIO = (16, 10)                 # Format: ([WIDTH], [HEIGHT])
...
init_method_index = 0                   # Default value for the calculation method setting. Index -1 refers to the dummy function.
